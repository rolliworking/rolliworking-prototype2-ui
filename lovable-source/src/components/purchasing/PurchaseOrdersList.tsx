...
interface PurchaseOrdersListProps {
  filter?: 'draft' | 'issued' | 'received';
}

export function PurchaseOrdersList({ filter }: PurchaseOrdersListProps) {
    ...
    <div className="p-6 space-y-6">
      ...
      {!filter && (
        <div className="grid grid-cols-4 gap-4">
          ...
          <Card className="cursor-pointer hover:bg-muted/50" onClick={() => setStatusFilter('issued')}>
            <CardContent className="pt-4">
              <div className="flex items-center justify-between">
                <div>
          ...
          <Card className="cursor-pointer hover:bg-muted/50" onClick={() => setStatusFilter('partial_received')}>
            <CardContent className="pt-4">
              <div className="flex items-center justify-between">
                <div>
          ...
          <Card className="cursor-pointer hover:bg-muted/50" onClick={() => setStatusFilter('received')}>
            <CardContent className="pt-4">
              <div className="flex items-center justify-between">
                <div>
        ...
        <CardContent className="p-0">
          {isLoading ? (
            ...
            <div className="text-center py-12 text-muted-foreground">
              ...
              <Button className="mt-4" onClick={handleNewPO}>
                <Plus className="h-4 w-4 mr-2" />
                Create First PO
              </Button>
            </div>
