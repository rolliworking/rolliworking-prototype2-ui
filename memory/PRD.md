...
### P2 Issues
- **Concierge Floor Map dead-end link** (P2): Concierge clicking a job from Floor Map gets a "Restricted" page. The link should be suppressed or adjusted. File: `src/pages/workshop/FloorMap.tsx`
