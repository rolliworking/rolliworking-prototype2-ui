...
import { ComponentChips, ComponentDoneButtons } from '@/components/jobs/ComponentBits';
...
export default function BenchPage() {
  ...
  const runBench = async (fn: () => Promise<unknown>, msg: string) => { try { await fn(); await load(); say(msg); } catch (e) { say(e instanceof Error ? e.message : 'Failed'); } };
