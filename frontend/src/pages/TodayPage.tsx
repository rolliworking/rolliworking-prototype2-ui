...
import type { TodaySource, TodayView } from '@/api/client';
...
export default function TodayPage() {
  ...
  return (
    <div data-testid="today-page" className="space-y-4">
      ...
      <Card accent="moss" bodyClassName="py-1" testId="today-list-card">
        <ul className="divide-y divide-line/70">
          {rows.map((r) => <TodayRowItem key={r.id} row={r} onDone={done} />)}
