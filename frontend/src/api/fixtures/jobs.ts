...
export const jobs: Job[] = [
  ...
  build({ id: 'j-08', number: 'E02018', estimateId: 'e-22', clientId: 'c-10', watchId: 'w-10', workflow: ['P'], status: 'closed', assignees: ['Walter'], createdDaysAgo: 38, dueInDays: -120, lines: [line('Case & bracelet refinish — brushed/polished', 340, 'P')] }),
