...
export const jobs: Job[] = [
  ...
  build({ id: 'j-06', number: 'E02016', estimateId: 'e-09', clientId: 'c-09', watchId: 'w-09', workflow: ['W', 'PM'], status: 'in_service', assignees: ['MM', 'Rosa'], createdDaysAgo: 18, dueInDays: 6, hold: { type: 'outsource', reason: 'Bezel out to plating vendor (Goldsmith & Co.) — due back Thursday', daysAgo: 4 } }),
