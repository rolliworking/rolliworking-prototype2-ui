...
export const hitList: HitListItem[] = [
  { id: 'h-01', title: 'Call Eleanor Vance re: Daytona estimate approval', ownerShortName: 'Vienna', priority: 'high', done: false, dueAt: daysFromNow(0, 12), relatedRef: 'EST-26-1042' },
  ...
  { id: 'h-07', title: 'Follow up on Pelagos estimate sent to Richard Stavros', ownerShortName: 'Walter', priority: 'normal', done: false, dueAt: daysFromNow(1, 14), relatedRef: 'EST-26-1051' },
  { id: 'h-08', title: 'Photograph Black Bay Chrono dial before band work', ownerShortName: 'MM', priority: 'normal', done: false, dueAt: daysFromNow(0, 13), relatedRef: 'EST-26-1052' },
